...
import net.mcreator.lillymod.entity.renderer.NerfRenderer;
import net.mcreator.lillymod.LillymodModElements;

import java.util.Random;

@LillymodModElements.ModElement.Tag
public class NerfItem extends LillymodModElements.ModElement {
	@ObjectHolder("lillymod:nerf")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletnerf").setRegistryName("entitybulletnerf");
	public NerfItem(LillymodModElements instance) {
		super(instance, 4);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NerfRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 5, 2);
